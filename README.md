...
1. Install Ben Barsdell's GPU De-dedispersion library "dedisp" that does an incoherent dedispersion from the "arch61" branch of this repo. https://github.com/ewanbarr/dedisp.git (Edit Makefile.inc and point to your CUDA installation)
